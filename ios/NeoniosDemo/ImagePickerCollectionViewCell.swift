...
//                                                                    if filePath.absoluteString.replacingOccurrences(of: "file:///", with: "") == item.getFilePath() {
//                                                                        self?.delegate?.updateCell(indexPath: indexPath, asset: asset, assetURL: filePath)
//                                                                        break
//                                                                    }
//                                                                }
//                                                            }
